...
public class MyClass {
    ...
    static {
        ...
        configuration.set("hbase.zookeeper.quorum", "10.64.66.215");
        configuration.set("hbase.master", "10.64.66.215:60000");
    }
    ...
    public static void createTable(String tableName) {
        ...
        try {
            Admin hBaseAdmin = conn.getAdmin();// new HBaseAdmin(configuration);
